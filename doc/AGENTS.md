...
- `doc/drafts/agent-protocol/capabilities.response.v1.1.draft.json`
- `doc/drafts/agent-protocol/agent-exec.request.v1.1.draft.json`
- `doc/drafts/agent-protocol/agent-exec.response.success.text.v1.1.draft.json`
- `doc/drafts/agent-protocol/agent-exec.response.success.image-inline.v1.1.draft.json`
- `doc/drafts/agent-protocol/agent-exec.response.error.v1.1.draft.json`
- `doc/drafts/agent-protocol/agent-exec.response.error.syntax.v1.1.draft.json`
- `doc/drafts/agent-protocol/agent-batch.contract.v1.1.draft.json`
- `doc/drafts/agent-protocol/syntax.profile.v1.draft.json`
